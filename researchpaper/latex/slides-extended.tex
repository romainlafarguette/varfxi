% Time-stamp: <2021-06-04 19:29:56 rlafarguette>
...
\begin{frame}
  \frametitle{BIS Survey: Goals}
    \makebox[\linewidth]{\includegraphics[width=0.9\paperwidth]{bis_survey_goals.PNG}}
\end{frame}


\begin{frame}
  \frametitle{BIS Survey: Intermediate Objectives}
    \makebox[\linewidth]{\includegraphics[width=0.9\paperwidth]{bis_survey_intermediate_objectives.PNG}}
\end{frame}
...
\begin{frame}
  \frametitle{Columbia FX Operations}
    \makebox[\linewidth]{\includegraphics[height=0.85\paperheight]{columbia_interventions.PNG}}
\end{frame}
...
\begin{frame}
  ...
  \item Guarantees \textbf{fixed-frequency} interventions: 
    ...
    \item \textbf{Certainty} about interventions: the central bank can intervene with
      \textbf{larger FX amounts}, making the interventions \textbf{more efficient}
...
\begin{frame}
  \frametitle{Financial Performances}
  \begin{largeitemize}
  \item We compared the financial performance of the three different
    interventions strategies: VaR, minimum price, without minimum price
  \item Using an entire year where the frequency of intervention was the same
    for auctions with and without minimum price
  \item We construct the counterfactual VaR interventions by calibrating the
    risk tolerance so that the frequency of intervention is the same as for
    auctions with and without minimum price
  \item Auctions with minimum price outperforms the no-minimum price auctions
    by 6.9\% on average
  \item The VaR rule outperforms the no-minimum price
    auctions by 8.3\% on average
  \end{largeitemize}
\end{frame}

\begin{frame}
  \frametitle{Financial Performances: Results}
  \begin{table}
    \begin{center}
      \scriptsize
      \input{../output/financial_perf_short.tex}
...
\begin{frame}{Alternative Models: Benchmarking}
    ...
    \begin{center}
      \scriptsize
      \input{../output/benchmark_table.tex}
\end{center}
\end{table}
            \normalsize
\end{frame}
