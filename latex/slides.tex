% Time-stamp: <2020-09-15 12:59:16 Romain>
...
\begin{frame}
  ...
  \item \textbf{No excessive interventions} in crisis time, which are often ineffective
  ...
  \item Guarantees \textbf{fixed-frequency} interventions: 
    ...
    \item \textbf{Certainty} about interventions: the central bank can intervene with
      \textbf{larger amounts}, more efficiently
