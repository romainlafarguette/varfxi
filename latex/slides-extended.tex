% Time-stamp: <2021-06-01 19:00:23 RLafarguette>
...
\begin{frame}
  \frametitle{BIS Survey: Goals}
    \makebox[\linewidth]{\includegraphics[width=\paperwidth]{bis_survey_goals.PNG}}
\end{frame}
...
\begin{frame}
  \frametitle{BIS Survey: Intermediate Objectives}
    \makebox[\linewidth]{\includegraphics[width=\paperwidth]{bis_survey_intermediate_objectives.PNG}}
\end{frame}
